...
bool operator==(const ::rosplan_knowledge_msgs::GetAttributeServiceResponse_<ContainerAllocator1> & lhs, const ::rosplan_knowledge_msgs::GetAttributeServiceResponse_<ContainerAllocator2> & rhs)
{
