...
"""autogenerated by genpy from motion_plan/PlanningActionResult.msg. Do not edit."""
import codecs
import sys
...
class PlanningActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "motion_plan/PlanningActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','motion_plan/PlanningResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanningActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = motion_plan.msg.PlanningResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = motion_plan.msg.PlanningResult()
