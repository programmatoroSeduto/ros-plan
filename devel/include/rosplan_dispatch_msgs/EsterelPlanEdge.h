...
#if defined(_WIN32) && defined(CONDITION_EDGE)
  #undef CONDITION_EDGE
#endif
#if defined(_WIN32) && defined(START_END_ACTION_EDGE)
  #undef START_END_ACTION_EDGE
#endif
#if defined(_WIN32) && defined(INTERFERENCE_EDGE)
  #undef INTERFERENCE_EDGE
#endif
...
bool operator==(const ::rosplan_dispatch_msgs::EsterelPlanEdge_<ContainerAllocator1> & lhs, const ::rosplan_dispatch_msgs::EsterelPlanEdge_<ContainerAllocator2> & rhs)
{
  return lhs.edge_type == rhs.edge_type &&
    lhs.edge_id == rhs.edge_id &&
    lhs.edge_name == rhs.edge_name &&
    lhs.signal_type == rhs.signal_type &&
    lhs.source_ids == rhs.source_ids &&
    lhs.sink_ids == rhs.sink_ids &&
    lhs.duration_lower_bound == rhs.duration_lower_bound &&
    lhs.duration_upper_bound == rhs.duration_upper_bound;
}
