...
if("TRUE" STREQUAL "TRUE")
  set(motion_plan_SOURCE_PREFIX /root/ros_ws/src/rt2_packages/motion_plan)
  set(motion_plan_DEVEL_PREFIX /root/ros_ws/devel)
  ...
  set(motion_plan_INSTALL_PREFIX /root/ros_ws/install)
...
if(NOT "/root/ros_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motion_plan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_ws/src/rt2_packages/motion_plan/${idir}'.  ${_report}")
    endif()
...
set(motion_plan_EXPORTED_TARGETS "motion_plan_generate_messages_cpp;motion_plan_generate_messages_eus;motion_plan_generate_messages_lisp;motion_plan_generate_messages_nodejs;motion_plan_generate_messages_py")
...
set(pkg_cfg_extras "motion_plan-msg-extras.cmake")
