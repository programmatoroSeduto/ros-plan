...
"""autogenerated by genpy from motion_plan/PlanningActionGoal.msg. Do not edit."""
import codecs
import sys
...
class PlanningActionGoal(genpy.Message):
  ...
  _type = "motion_plan/PlanningActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','motion_plan/PlanningGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = motion_plan.msg.PlanningGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = motion_plan.msg.PlanningGoal()
