...
"""autogenerated by genpy from smach_tutorials/TestAction.msg. Do not edit."""
import codecs
import sys
...
import genpy
import smach_tutorials.msg
import std_msgs.msg

class TestAction(genpy.Message):
  _md5sum = "ab82b566022c36cd43fd6616bdfbeffe"
  _type = "smach_tutorials/TestAction"
...
"""
  ...
  _slot_types = ['smach_tutorials/TestActionGoal','smach_tutorials/TestActionResult','smach_tutorials/TestActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = smach_tutorials.msg.TestActionGoal()
      if self.action_result is None:
        self.action_result = smach_tutorials.msg.TestActionResult()
      if self.action_feedback is None:
        self.action_feedback = smach_tutorials.msg.TestActionFeedback()
    else:
      self.action_goal = smach_tutorials.msg.TestActionGoal()
      self.action_result = smach_tutorials.msg.TestActionResult()
      self.action_feedback = smach_tutorials.msg.TestActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_d3I().pack(_x.action_goal.goal.goal, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.goal, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
