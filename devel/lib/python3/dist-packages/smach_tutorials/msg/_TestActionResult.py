...
"""autogenerated by genpy from smach_tutorials/TestActionResult.msg. Do not edit."""
import codecs
import sys
...
class TestActionResult(genpy.Message):
  ...
  _type = "smach_tutorials/TestActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','smach_tutorials/TestResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = smach_tutorials.msg.TestResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = smach_tutorials.msg.TestResult()
