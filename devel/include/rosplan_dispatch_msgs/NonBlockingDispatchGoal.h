...
bool operator==(const ::rosplan_dispatch_msgs::NonBlockingDispatchGoal_<ContainerAllocator1> & lhs, const ::rosplan_dispatch_msgs::NonBlockingDispatchGoal_<ContainerAllocator2> & rhs)
{
