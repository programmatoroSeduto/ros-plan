...
bool operator==(const ::rosplan_knowledge_msgs::SetFloatRequest_<ContainerAllocator1> & lhs, const ::rosplan_knowledge_msgs::SetFloatRequest_<ContainerAllocator2> & rhs)
{
