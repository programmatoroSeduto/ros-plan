...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef FUNCTION
#endif
#if defined(_WIN32) && defined(OPERATOR)
  #undef OPERATOR
#endif
  ...
  #undef ADD
#endif
#if defined(_WIN32) && defined(SUB)
  #undef SUB
#endif
#if defined(_WIN32) && defined(MUL)
  #undef MUL
#endif
#if defined(_WIN32) && defined(DIV)
  #undef DIV
#endif
#if defined(_WIN32) && defined(UMINUS)
  #undef UMINUS
#endif
#if defined(_WIN32) && defined(HASHT)
  #undef HASHT
#endif
#if defined(_WIN32) && defined(TOTAL_TIME)
  #undef TOTAL_TIME
#endif
...
bool operator==(const ::rosplan_knowledge_msgs::ExprBase_<ContainerAllocator1> & lhs, const ::rosplan_knowledge_msgs::ExprBase_<ContainerAllocator2> & rhs)
{
  return lhs.expr_type == rhs.expr_type &&
    lhs.constant == rhs.constant &&
    lhs.function == rhs.function &&
    lhs.op == rhs.op &&
    lhs.special_type == rhs.special_type;
}
