...
bool operator==(const ::rosplan_dispatch_msgs::NonBlockingDispatchResult_<ContainerAllocator1> & lhs, const ::rosplan_dispatch_msgs::NonBlockingDispatchResult_<ContainerAllocator2> & rhs)
{
