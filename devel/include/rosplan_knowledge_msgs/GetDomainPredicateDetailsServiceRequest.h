...
bool operator==(const ::rosplan_knowledge_msgs::GetDomainPredicateDetailsServiceRequest_<ContainerAllocator1> & lhs, const ::rosplan_knowledge_msgs::GetDomainPredicateDetailsServiceRequest_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::rosplan_knowledge_msgs::GetDomainPredicateDetailsServiceRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Fetching the Domain (1.5/3):\n"
