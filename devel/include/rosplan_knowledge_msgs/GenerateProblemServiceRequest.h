...
bool operator==(const ::rosplan_knowledge_msgs::GenerateProblemServiceRequest_<ContainerAllocator1> & lhs, const ::rosplan_knowledge_msgs::GenerateProblemServiceRequest_<ContainerAllocator2> & rhs)
{
  return lhs.problem_path == rhs.problem_path &&
    lhs.contingent == rhs.contingent;
}
...
struct Definition< ::rosplan_knowledge_msgs::GenerateProblemServiceRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# simple service for generating a PDDL problem with goals from the KMS\n"
"string problem_path\n"
"bool contingent\n"
;
  }
