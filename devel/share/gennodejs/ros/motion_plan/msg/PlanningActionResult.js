...
class PlanningActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PlanningResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanningActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = PlanningResult.Resolve(msg.result)
    }
    else {
      resolved.result = new PlanningResult()
    }
...
module.exports = PlanningActionResult;
