...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/root/ros_ws/src/SLAM_packages/octomap_ros/include;/opt/ros/noetic/include".split(';') if "/root/ros_ws/src/SLAM_packages/octomap_ros/include;/opt/ros/noetic/include" != "" else []
