...
bool operator==(const ::rosplan_knowledge_msgs::GetDomainTypeServiceResponse_<ContainerAllocator1> & lhs, const ::rosplan_knowledge_msgs::GetDomainTypeServiceResponse_<ContainerAllocator2> & rhs)
{
  return lhs.types == rhs.types &&
    lhs.super_types == rhs.super_types;
}
