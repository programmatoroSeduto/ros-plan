...
"""autogenerated by genpy from smach_tutorials/TestActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TestActionFeedback(genpy.Message):
  ...
  _type = "smach_tutorials/TestActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','smach_tutorials/TestFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = smach_tutorials.msg.TestFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = smach_tutorials.msg.TestFeedback()
