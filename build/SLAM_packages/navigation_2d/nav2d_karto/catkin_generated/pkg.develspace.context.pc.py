...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/root/ros_ws/src/SLAM_packages/navigation_2d/nav2d_karto/include".split(';') if "/root/ros_ws/src/SLAM_packages/navigation_2d/nav2d_karto/include" != "" else []
