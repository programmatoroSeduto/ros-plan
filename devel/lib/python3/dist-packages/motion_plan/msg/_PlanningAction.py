...
"""autogenerated by genpy from motion_plan/PlanningAction.msg. Do not edit."""
import codecs
import sys
...
class PlanningAction(genpy.Message):
  _md5sum = "431e47e5e8e59a5a29ca8efdcf8a348c"
  _type = "motion_plan/PlanningAction"
...
"""
  ...
  _slot_types = ['motion_plan/PlanningActionGoal','motion_plan/PlanningActionResult','motion_plan/PlanningActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanningAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = motion_plan.msg.PlanningActionGoal()
      if self.action_result is None:
        self.action_result = motion_plan.msg.PlanningActionResult()
      if self.action_feedback is None:
        self.action_feedback = motion_plan.msg.PlanningActionFeedback()
    else:
      self.action_goal = motion_plan.msg.PlanningActionGoal()
      self.action_result = motion_plan.msg.PlanningActionResult()
      self.action_feedback = motion_plan.msg.PlanningActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d().pack(_x.action_feedback.feedback.actual_pose.position.x, _x.action_feedback.feedback.actual_pose.position.y, _x.action_feedback.feedback.actual_pose.position.z, _x.action_feedback.feedback.actual_pose.orientation.x, _x.action_feedback.feedback.actual_pose.orientation.y, _x.action_feedback.feedback.actual_pose.orientation.z, _x.action_feedback.feedback.actual_pose.orientation.w))
      _x = self.action_feedback.feedback.stat
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_feedback.feedback.actual_pose.position.x, _x.action_feedback.feedback.actual_pose.position.y, _x.action_feedback.feedback.actual_pose.position.z, _x.action_feedback.feedback.actual_pose.orientation.x, _x.action_feedback.feedback.actual_pose.orientation.y, _x.action_feedback.feedback.actual_pose.orientation.z, _x.action_feedback.feedback.actual_pose.orientation.w,) = _get_struct_7d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_feedback.feedback.stat = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_feedback.feedback.stat = str[start:end]
      return self
