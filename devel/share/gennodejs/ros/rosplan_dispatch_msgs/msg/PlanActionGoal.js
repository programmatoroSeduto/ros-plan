...
class PlanActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PlanGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PlanGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PlanGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PlanGoal()
    }
