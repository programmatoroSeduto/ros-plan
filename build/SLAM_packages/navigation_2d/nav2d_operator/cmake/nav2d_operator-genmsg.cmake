...
set(MSG_I_FLAGS "-Inav2d_operator:/root/ros_ws/src/SLAM_packages/navigation_2d/nav2d_operator/msg")
...
get_filename_component(_filename "/root/ros_ws/src/SLAM_packages/navigation_2d/nav2d_operator/msg/cmd.msg" NAME_WE)
add_custom_target(_nav2d_operator_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "nav2d_operator" "/root/ros_ws/src/SLAM_packages/navigation_2d/nav2d_operator/msg/cmd.msg" ""
)
...
_generate_msg_cpp(nav2d_operator
  "/root/ros_ws/src/SLAM_packages/navigation_2d/nav2d_operator/msg/cmd.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/nav2d_operator)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/nav2d_operator\")")
  # install generated code
  install(
