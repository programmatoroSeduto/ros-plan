...
bool operator==(const ::rosplan_knowledge_msgs::GenerateProblemServiceResponse_<ContainerAllocator1> & lhs, const ::rosplan_knowledge_msgs::GenerateProblemServiceResponse_<ContainerAllocator2> & rhs)
{
