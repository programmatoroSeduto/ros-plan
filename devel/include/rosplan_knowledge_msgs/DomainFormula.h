...
bool operator==(const ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator1> & lhs, const ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator2> & rhs)
{
  return lhs.name == rhs.name &&
    lhs.typed_parameters == rhs.typed_parameters;
}
