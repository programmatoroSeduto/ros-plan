...
bool operator==(const ::rosplan_knowledge_msgs::KnowledgeQueryServiceResponse_<ContainerAllocator1> & lhs, const ::rosplan_knowledge_msgs::KnowledgeQueryServiceResponse_<ContainerAllocator2> & rhs)
{
  return lhs.all_true == rhs.all_true &&
    lhs.results == rhs.results &&
    lhs.false_knowledge == rhs.false_knowledge;
}
