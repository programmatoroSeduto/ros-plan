...
bool operator==(const ::rosplan_dispatch_msgs::PlanFeedback_<ContainerAllocator1> & lhs, const ::rosplan_dispatch_msgs::PlanFeedback_<ContainerAllocator2> & rhs)
{
  return lhs.current_phase == rhs.current_phase &&
    lhs.current_status == rhs.current_status &&
    lhs.percent_completed == rhs.percent_completed;
}
