...
class PlanningServiceRequest {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.domain_path);
    length += _getByteLength(object.problem_path);
    length += _getByteLength(object.data_path);
    length += _getByteLength(object.planner_command);
    return length + 17;
  }
