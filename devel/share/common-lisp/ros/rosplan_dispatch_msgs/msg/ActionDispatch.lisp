...
(cl:defmethod plan_id-val ((m <ActionDispatch>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ActionDispatch>)))
  ...
  "9d0c5c1ebcb48d5f31ecc568f41bc70b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ActionDispatch)))
  "Returns md5sum for a message object of type 'ActionDispatch"
  "9d0c5c1ebcb48d5f31ecc568f41bc70b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ActionDispatch>)))
  ...
  (cl:format cl:nil "#actionDispatch message~%int32 action_id~%int32 plan_id~%string name~%diagnostic_msgs/KeyValue[] parameters~%float32 duration~%float32 dispatch_time~%~%================================================================================~%MSG: diagnostic_msgs/KeyValue~%string key # what to label this value when viewing~%string value # a value to track over time~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ActionDispatch)))
  "Returns full string definition for message of type 'ActionDispatch"
  (cl:format cl:nil "#actionDispatch message~%int32 action_id~%int32 plan_id~%string name~%diagnostic_msgs/KeyValue[] parameters~%float32 duration~%float32 dispatch_time~%~%================================================================================~%MSG: diagnostic_msgs/KeyValue~%string key # what to label this value when viewing~%string value # a value to track over time~%~%~%"))
