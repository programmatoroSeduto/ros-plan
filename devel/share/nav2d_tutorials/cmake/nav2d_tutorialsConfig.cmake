...
if("TRUE" STREQUAL "TRUE")
  set(nav2d_tutorials_SOURCE_PREFIX /root/ros_ws/src/SLAM_packages/navigation_2d/nav2d_tutorials)
  set(nav2d_tutorials_DEVEL_PREFIX /root/ros_ws/devel)
  ...
  set(nav2d_tutorials_INSTALL_PREFIX /root/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/nav2d_tutorials " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/nav2d_tutorials' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'nav2d_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'nav2d_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_ws/src/SLAM_packages/navigation_2d/nav2d_tutorials/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT nav2d_tutorials_NUM_DUMMY_TARGETS)
      set(nav2d_tutorials_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::nav2d_tutorials::wrapped-linker-option${nav2d_tutorials_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR nav2d_tutorials_NUM_DUMMY_TARGETS "${nav2d_tutorials_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::nav2d_tutorials::wrapped-linker-option${nav2d_tutorials_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND nav2d_tutorials_LIBRARIES "${interface_target_name}")
