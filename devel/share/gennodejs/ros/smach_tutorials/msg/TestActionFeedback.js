...
class TestActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TestFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TestActionFeedback(null);
    ...
    data.feedback = TestFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TestActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TestFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TestFeedback()
    }
...
module.exports = TestActionFeedback;
