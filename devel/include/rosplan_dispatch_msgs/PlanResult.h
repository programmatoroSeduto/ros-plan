...
bool operator==(const ::rosplan_dispatch_msgs::PlanResult_<ContainerAllocator1> & lhs, const ::rosplan_dispatch_msgs::PlanResult_<ContainerAllocator2> & rhs)
{
  return lhs.result_status == rhs.result_status;
}
