...
bool operator==(const ::rosplan_dispatch_msgs::CompletePlan_<ContainerAllocator1> & lhs, const ::rosplan_dispatch_msgs::CompletePlan_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::rosplan_dispatch_msgs::CompletePlan_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x18e478092c6dc720ULL;
  static const uint64_t static_value2 = 0x696935108af2bf4dULL;
};
