...
bool operator==(const ::rosplan_knowledge_msgs::SetFloatResponse_<ContainerAllocator1> & lhs, const ::rosplan_knowledge_msgs::SetFloatResponse_<ContainerAllocator2> & rhs)
{
