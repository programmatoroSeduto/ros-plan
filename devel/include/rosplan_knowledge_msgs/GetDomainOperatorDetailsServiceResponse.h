...
bool operator==(const ::rosplan_knowledge_msgs::GetDomainOperatorDetailsServiceResponse_<ContainerAllocator1> & lhs, const ::rosplan_knowledge_msgs::GetDomainOperatorDetailsServiceResponse_<ContainerAllocator2> & rhs)
{
