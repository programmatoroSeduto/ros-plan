...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef ACTION_END
#endif
#if defined(_WIN32) && defined(PLAN_START)
  #undef PLAN_START
#endif
...
bool operator==(const ::rosplan_dispatch_msgs::EsterelPlanNode_<ContainerAllocator1> & lhs, const ::rosplan_dispatch_msgs::EsterelPlanNode_<ContainerAllocator2> & rhs)
{
  return lhs.node_type == rhs.node_type &&
    lhs.node_id == rhs.node_id &&
    lhs.name == rhs.name &&
    lhs.action == rhs.action &&
    lhs.edges_out == rhs.edges_out &&
    lhs.edges_in == rhs.edges_in;
}
...
struct MD5Sum< ::rosplan_dispatch_msgs::EsterelPlanNode_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x56c4d424c0ed136cULL;
  static const uint64_t static_value2 = 0xc9c74dbcf89f9977ULL;
};
