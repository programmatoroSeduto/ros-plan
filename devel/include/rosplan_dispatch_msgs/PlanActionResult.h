...
bool operator==(const ::rosplan_dispatch_msgs::PlanActionResult_<ContainerAllocator1> & lhs, const ::rosplan_dispatch_msgs::PlanActionResult_<ContainerAllocator2> & rhs)
{
