...
class PlanActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PlanFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PlanActionFeedback
    ...
    bufferOffset = PlanFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PlanActionFeedback
    let len;
    let data = new PlanActionFeedback(null);
    ...
    data.feedback = PlanFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PlanFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PlanFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PlanFeedback()
    }
...
module.exports = PlanActionFeedback;
